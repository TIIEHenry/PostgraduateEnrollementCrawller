...
enum class Subjects(val subjectCode: String, val subjectName: String) {
    金融_0251("0251", "金融"),
    应用统计_0252("0252", "应用统计"),
    税务_0253("0253", "税务"),
    国际商务_0254("0254", "国际商务"),
    ...
    教育_0451("0451", "教育"),
    体育_0452("0452", "体育"),
    汉语国际教育_0453("0453", "汉语国际教育"),
    应用心理_0454("0454", "应用心理"),
    翻译_0551("0551", "翻译"),
    新闻与传播_0552("0552", "新闻与传播"),
    出版_0553("0553", "出版"),
    文物与博物馆_0651("0651", "文物与博物馆"),
    建筑学_0851("0851", "建筑学"),
    城市规划_0853("0853", "城市规划"),
    电子信息_0854("0854", "电子信息"),
    机械_0855("0855", "机械"),
    材料与化工_0856("0856", "材料与化工"),
    资源与环境_0857("0857", "资源与环境"),
    能源动力_0858("0858", "能源动力"),
    土木水利_0859("0859", "土木水利"),
    生物与医药_0860("0860", "生物与医药"),
    交通运输_0861("0861", "交通运输"),
    农业_0951("0951", "农业"),
    兽医_0952("0952", "兽医"),
    风景园林_0953("0953", "风景园林"),
    ...
    companion object {
        fun fromCode(code: String): Subjects? {
            values().forEach {
                if (it.subjectCode == code)
                    return it
            }
            return null;
        }
        fun fromNameFuzzy(name: String): Subjects? {
            values().forEach {
                if (it.subjectName == name)
                    return it
                if (it.subjectName.startsWith(name))
                    return it;
            }
            return null;
        }
